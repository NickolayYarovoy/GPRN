...
namespace Hash
{
    ...
    {
        /// <summary>Bad hash with aproximatly 8.3% collisions on 326797 elements</summary>
        /// <param name="input">Input string</param>
        /// <returns>UInt32 hash</returns>
        ...
        /// <summary>Good hash with aproximatly 0.004% collisions elements</summary>
        /// <param name="input">Input string</param>
        /// <returns>UInt32 hash</returns>
        ...
        /// <summary>Search element by GoodHash in LookUp</summary>
        /// <param name="data">Input LookUp</param>
        /// <param name="find">Element that we need to find</param>
        /// <returns>Element that finds</returns>
        ...
        /// <summary>Search element by BadHash in LookUp</summary>
        /// <param name="data">Input LookUp</param>
        /// <param name="find">Element that we need to find</param>
        /// <returns>Element that finds</returns>
        ...
        /// <summary>Create random string</summary>
